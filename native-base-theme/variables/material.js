...
const primaryColor = '#50B848';
const primaryLightColor = '#84EB77';
const primaryDarkColor = '#0B8717';
const primaryTextColor = '#C8E6C9';
...
export default {
  ...
  // FooterTab
  tabBarTextColor: 'primaryTextColor',
  tabBarTextSize: 11,
  activeTab: '#fff',
  ...
  // Tab
  tabDefaultBg: '#fff',
  topTabBarTextColor: '#31455E',
  topTabBarActiveTextColor: '#fff',
  topTabBarBorderColor: '#fff',
  topTabBarActiveBorderColor: '#31455E',
